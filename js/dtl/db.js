...
this['テーブル']['x']=((1)+((this['画面']['幅?']())/-(2)));
this['テーブル']['y']=((this['画面']['高さ?']())/(2));
...
fld_tmp=(this['dt']['読む']((1)))['分割']((this['deli']));
fld=this['配列']['作る']();
...
lst=this['テキストエリア']['作る']()['大きさ'](((((23)+(((幅+要素数))*(8)))+this['補正値'])),(400))['位置']((this['テーブル']['x']),(this['テーブル']['y']));
return this['テーブル']['x']=((this['テーブル']['x'])+((((23)+(((幅+要素数))*(8)))+this['補正値'])));
}))['実行'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
lst=this['テキストエリア']['作る']()['大きさ']((((23)+(((幅+要素数))*(8)))),(400))['位置']((this['テーブル']['x']),(this['テーブル']['y']));
return this['テーブル']['x']=((this['テーブル']['x'])+(((23)+(((幅+要素数))*(8)))));
}));
レコード=((レコード+s)+"\n");
this['データ']['それぞれ実行'](dtlbind(this,function(n,i){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,2);
...
this['_max']=freq_arr['最大値']("度数")['数にする']();
_max_rec=freq_arr['レコード取り出し']((this['_max']),(2));
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return _min=root['window']['parseFloat']((f1_arr['データ']['最小']()));
}));
dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (_max===this['undef']);
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return _max=root['window']['parseFloat']((f1_arr['データ']['最大']()));
}));
this['sum']=(_max-_min);
dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
...
dtlbind(this,function(n){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,1);
this['階級']['書く']((this['配列']['作る'](((((((((_min+(階級幅*((n-(1))))))*(100))).round()/(100))+""))['連結']((("~"+((((((_min+(階級幅*n)))*(100))).round()/(100))))))))));
(this['階級']['読む']((n)))['書く']((0));
return dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (n===(1));
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return this['_max']=args['読む']((4));
}));
freq=this['度数分布']((f1),(this['階級数']),(this['_min']),(this['_max']));
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
this['_原点x']=((((this['テーブル']['x'])+(120))+this['_原点x']));
this['_左端']=((this['_原点x']-(30)));
return this['_右端']=(((this['_原点x']+this['_横幅'])+(10)));
});
...
this['ラベル']['作る']((this['_横軸タイトル文']))['文字サイズ']((this['_タイトルサイズ']))['位置']((((this['_左端']+(((this['_右端']-this['_左端']))/(2)))-(文字数*(5)))),(this['_底']));
this['_底']=(this['_底']-(20));
return this;
});
...
this['縦表示']((this['_縦軸タイトル文']),(this['_左端']),(((this['_底']+(((this['_天井']-this['_底']))/(2)))+(文字数*(5)))),"title");
this['_左端']=(this['_左端']-(10));
return this;
});
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,2);
this['_原点x']=(this['_原点x']+x);
this['_原点y']=(this['_原点y']+y);
this['_左端']=(this['_左端']+y);
this['_右端']=(this['_右端']+y);
this['_天井']=(this['_天井']+y);
this['_底']=(this['_底']+y);
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,2);
this['ラベル']['作る']((((this['_scale']*i)+起点メモリ)))['位置'](((this['_原点x']-this['調整'])),((((this['_原点y']+(((this['_縦幅']/this['_段数']))*i)))+(10))))['文字サイズ']((this['_軸ラベルサイズ']));
return ペン['線の太さ']((1))['線の色']((col))['ペンなし']()['位置']((this['_原点x']),((this['_原点y']+(((this['_縦幅']/this['_段数']))*i))))['ペンあり']()['歩く']((this['_横幅']));
});
this['縦軸描画']=dtlbind(this,function(i,起点メモリ){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,2);
this['幅']=(((((this['_scale']*i)).floor())+""))['長さ?']();
this['ラベル']['作る']((((this['_scale']*i)+起点メモリ)))['位置']((((this['_原点x']+(((this['_横幅']/this['_段数'])*i)))-(this['幅']*(5)))),((this['_原点y']-(10))))['文字サイズ']((this['_軸ラベルサイズ']));
return ペン['線の太さ']((1))['線の色']((col))['ペンなし']()['位置'](((this['_原点x']+(((this['_横幅']/this['_段数']))*i))),(this['_原点y']))['ペンあり']()['歩く']((this['_縦幅']));
});
...
this['横軸描画']['実行']((i),(this['起点メモリ']));
return this['_天井']=((this['_原点y']+(((this['_縦幅']/this['_段数']))*i))+(30));
}));
return dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['_最小メモリ']<(0));
...
this['横軸描画']['実行']((i),(this['起点メモリ']));
return this['_底']=((this['_原点y']+(((this['_縦幅']/this['_段数']))*i))-(10));
}));
}))['なら'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['_方向']==="横");
...
this['縦軸描画']['実行']((i),(this['起点メモリ']));
return this['_右端']=((this['_原点x']+(((this['_横幅']/this['_段数']))*i))+(20));
}));
return dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['_最小メモリ']<(0));
...
this['縦軸描画']['実行']((i),(this['起点メモリ']));
return this['_左端']=((this['_原点x']+(((this['_横幅']/this['_段数']))*i))-(40));
}));
}))['なら'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['_方向']==="帯");
...
ペン['ペンなし']()['位置']((this['_原点x']),(this['_原点y']));
this['_底']=(this['_原点y']-(40));
this['_天井']=(this['_原点y']+(330));
this['メモリ']=(0);
dtlbind(this,function(i){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,1);
this['幅']=((this['メモリ']+""))['長さ?']();
this['ラベル']['作る']((this['メモリ']))['文字サイズ']((this['_軸ラベルサイズ']))['位置']((((this['_原点x']+((100)*((i-(1)))))-(this['幅']*(5)))),((this['_原点y']-(10))));
ペン['ペンあり']()['歩く']((this['_縦幅']));
ペン['ペンなし']()['位置'](((this['_原点x']+((100)*i))),(this['_原点y']));
return this['メモリ']=(this['メモリ']+(20));
})['繰り返す']((6));
return this['_右端']=((this['_原点x']+(500))+(20));
}))['なら'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['_方向']==="散布図");
}))['実行'](dtlbind(this,function(){
...
ペン['ペンなし']()['位置']((this['_原点x']),((this['_原点y']+((this['_横幅']/this['_段数y'])*i))));
return this['ラベル']['作る'](((this['_scaley']*((i-(1))))))['文字サイズ']((this['_軸ラベルサイズ']))['位置']((((this['_原点x']-this['調整'])-(10))),((((this['_原点y']+(((this['_縦幅']/this['_段数y']))*((i-(1))))))+(10))));
})['繰り返す'](((this['_段数y']+(1))));
ペン['ペンなし']()['位置']((this['_原点x']),(this['_原点y']))['左回り']((90));
return dtlbind(this,function(i){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,1);
...
ペン['ペンなし']()['位置'](((this['_原点x']+((this['_縦幅']/this['_段数x'])*i))),(this['_原点y']));
return this['ラベル']['作る'](((this['_scalex']*((i-(1))))))['文字サイズ']((this['_軸ラベルサイズ']))['位置']((((this['_原点x']+(((this['_横幅']/this['_段数x'])*((i-(1))))))-(this['幅']*(5)))),((this['_原点y']-(10))));
})['繰り返す'](((this['_段数x']+(1))));
}));
this['_起点メモリ']=this['起点メモリ'];
ペン['図形を作る']();
ペン['消える']();
return this;
});
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
this['_横幅']=(500);
this['_右端']=((this['_原点x']+this['_横幅'])+(30));
...
this['始点x']=this['_原点x'];
this['始点y']=(this['_原点y']+(this['切片']*this['_DACOLY']));
this['終点x']=(this['_原点x']+(this['x2']*this['_DACOLX']));
this['終点y']=(this['_原点y']+(this['y2']*this['_DACOLY']));
dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (this['始点y']<this['_原点y']);
})['なら']()['実行'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
this['始点x']=((((this['切片']/((-(1)*this['傾き']))))*this['_DACOLX'])+this['_原点x']);
return this['始点y']=this['_原点y'];
}));
dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
this['終点x']=(((((((this['_scaley']*this['_段数y']))-this['切片']))/this['傾き'])*this['_DACOLX'])+this['_原点x']);
return this['終点_y']=((((this['_scaley']*this['_段数y']))*this['_DACOLX'])+this['_原点y']);
}));
...
this['ラベル']['作る']((((("y="+(this['傾き']))+"x+")+(this['切片']))))['文字サイズ'](((this['_軸ラベルサイズ']-(4))))['位置']((((this['_原点x']+(this['x2']*this['_DACOLX']))+(10))),(((this['_原点y']+(this['y2']*this['_DACOLY']))+(5))));
this['ペン']['消える']();
this['式の長さ']=(((("y="+(this['傾き']))+"x+")+(this['切片'])))['長さ?']();
this['_右端']=(((this['_原点x']+(this['_横幅']))+(40))+((this['式の長さ']*(10))));
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return _SIZE=this['_タイトルサイズ'];
}))['実行'](dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return _SIZE=this['_軸ラベルサイズ'];
}));
dtlbind(this,function(i){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,1);
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,2);
this['付箋']=this['ラベル']['作る']((n))['位置']((x),((y-((15)*i))))['文字サイズ']((_SIZE));
this['付箋']['タイプ']="縦軸タイトル";
return this['縦の位置']=((y-((12)*i)));
}));
})['繰り返す']((文字数));
return dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
...
this['テーブル']['ヒストグラム']=dtlbind(this,function(f2){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,1);
var tmp;
...
this['_右端']=((this['_原点x']+this['x_pos'])+((15)*(this['_max_length'])));
this['テーブル']['x']=this['_右端'];
this['ラベル']['作る']("　")['位置']((this['_右端']),(0));
this['ペン']['消える']();
return this;
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return this['ラベル']['作る'](((this['割合']+"%")))['位置'](((((this['_原点x']+(this['横の位置配列']['読む']((i))))+(((this['割合']*(5)))/(2)))-(10))),((((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*i))-(this['_プロット幅']/(2)))+(5))))['文字サイズ'](((this['_軸ラベルサイズ']-(3))));
}));
...
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
this['ペン']['ペンなし']()['位置'](((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))),((this['_原点y']+(n*this['_DACOL']))))['ぺんあり']()['円']((3));
...
this['ペン']['ペンなし']()['位置'](((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))),((this['_原点y']+(this['_max']*this['_DACOL']))))['ペンあり']()['位置'](((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))),((this['_原点y']+(this['qua3']*this['_DACOL']))));
this['ペン']['ペンなし']()['位置'](((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))),((this['_原点y']+(this['qua1']*this['_DACOL']))))['ペンあり']()['位置'](((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))),((this['_原点y']+(this['_min']*this['_DACOL']))));
...
this['ペン']['ペンなし']()['位置']((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])),((this['_原点y']+(this['_max']*this['_DACOL']))))['ペンあり']()['歩く']((this['_プロット幅']));
this['ペン']['ペンなし']()['位置']((((this['_原点x']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])),((this['_原点y']+(this['_min']*this['_DACOL']))))['ペンあり']()['歩く']((this['_プロット幅']))['ペンなし']();
...
this['ペン']['ペンなし']()['位置'](((this['_原点x']+(this['_max']*this['_DACOL']))),((((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))))['ペンあり']()['位置'](((this['_原点x']+(this['qua3']*this['_DACOL']))),((((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))));
this['ペン']['ペンなし']()['位置'](((this['_原点x']+(this['qua1']*this['_DACOL']))),((((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))))['ペンあり']()['位置'](((this['_原点x']+(this['_min']*this['_DACOL']))),((((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])+((this['_プロット幅']/(2))))));
...
this['ペン']['ペンなし']()['位置'](((this['_原点x']+(this['_max']*this['_DACOL']))),(((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])))['ペンあり']()['歩く']((this['_プロット幅']));
this['ペン']['ペンなし']()['位置'](((this['_原点x']+(this['_min']*this['_DACOL']))),(((this['_原点y']+(((this['_間隔']+this['_プロット幅']))*cnt))-this['_プロット幅'])))['ペンあり']()['歩く']((this['_プロット幅']))['ペンなし']();
this['プロット']=this['ペン']['図形にする']();
return dtlbind(this,function(){
var self=this;var 自分=self;var _rest=Array.prototype.slice.call(arguments,0);
return (cnt===(1));
...
テーブル：表示＝「| ;要素数 文字列 レコード カラム名 tmp space s 幅 文字数 lst 件数 |
    ...
    「要素数==1」!なら「
        ...
        「補正値=横幅」実行。
        //lst=テキストエリア！ (カラム名) 作る (23+(幅+要素数)*8+補正値) 400 大きさ (テーブル：x) (テーブル：y) 位置。
		　　lst=テキストエリア！  作る (23+(幅+要素数)*8+補正値) 400 大きさ (テーブル：x) (テーブル：y) 位置。
        テーブル：x=(テーブル：x)+(23+(幅+要素数)*8+補正値)。
    」そうでなければ「
        //lst=テキストエリア！(カラム名) 作る (23+(幅+要素数)*8) 400 大きさ (テーブル：x) (テーブル：y) 位置。
		  lst=テキストエリア！作る (23+(幅+要素数)*8) 400 大きさ (テーブル：x) (テーブル：y) 位置。
        テーブル：x=(テーブル：x)+(23+(幅+要素数)*8)。
    」実行。
    //lst!(s) 書く  改行。
	レコード=レコード+s+"\n"。
...
テーブル:check_arg=「| args option ;_max flag|
    「args!=undef」!なら「
        ...
        「option=="freq"」!なら「
            ...
            「(arg_num)>=4」!なら「_max=args!4  読む」実行。
            「階級幅!=undef」!なら「
...
//データ分析機能の定義
テーブル：最大値＝「|;ret f１  f1_arr _max args arg_num|
    args=自分!(_rest) getarg。
	「args==undef」!なら「
		args=自分!_引数設定。
	」実行。
...
テーブル：最小値＝「|;ret f1_arr _min args arg_num|
    args=自分!(_rest) getarg。
	「args==undef」!なら「
		args=自分!_引数設定。
	」実行。
...
テーブル：最頻値＝「| ;freq_arr _max_rec args arg_num|
    args=自分!(_rest) getarg。
...
テーブル：度数分布＝「｜；ret args arg_num 件数 f1_arr _min _max 階級幅 f1 flag｜
    ...
    「自分!(args) "freq" check_arg」!なら「
        ...
        階級=配列！作る。
        カウント=配列！作る。
        //「_min==undef」！なら「_min=f1_arr：データ!最小。」実行。
        //「_max==undef」！なら「_max=f1_arr：データ!最大。」実行。
        ...
        「| n |
             ...
             階級!(配列! ((round((_min+階級幅*(n-1))*100)/100+"")!("~"+(round((_min+階級幅*n)*100)/100)) 連結) 作る) 書く。
            (階級!(n) 読む)! 0 書く。
            「n==1」！なら「カウント!(_min+階級幅*(n-1)) 書く。」そうでなければ「カウント!(_min+階級幅*(n-1)) 書く。」実行。
        」！(階級数) 繰り返す。
...
グラフ：位置確定=「
    自分：_原点x=((テーブル:x)+120+自分：_原点x)。
    自分：_左端=(自分：_原点x-30)。
    自分：_右端=(自分：_原点x+自分:_横幅+１0)。
」。
...
グラフ：横軸タイトル描画＝「|option ;画面パーツ 付箋  文字数|
    文字数＝自分:_横軸タイトル文！長さ?。
    ラベル！(自分:_横軸タイトル文) 作る (自分:_タイトルサイズ) 文字サイズ (自分:_左端+(自分:_右端-自分:_左端)/2-文字数*5) (自分:_底) 位置。
    自分:_底＝自分:_底-20。
    自分。
」。
...
グラフ：縦軸タイトル描画＝「 |;画面パーツ 付箋  文字数|
    文字数＝自分:_縦軸タイトル文！長さ?。
    自分！(自分:_縦軸タイトル文) (自分:_左端) (自分:_底+(自分:_天井-自分:_底)/2+文字数*5) "title" 縦表示。
    自分:_左端=自分:_左端-10。
    自分。
」。
...
グラフ:メモリ線描画＝「｜要素数 ;ペン col  軸線 i｜
    ...
    横軸描画＝「| i 起点メモリ |
        ラベル!(自分:_scale*i+起点メモリ) 作る  (自分:_原点x-調整) ((自分:_原点y+(自分:_縦幅/自分:_段数)*i)+10)  位置   (自分：_軸ラベルサイズ)  文字サイズ  。
        ペン！1 線の太さ  (col)  線の色 ペンなし (自分:_原点x) (自分:_原点y+(自分:_縦幅/自分:_段数)*i) 位置 ペンあり (自分:_横幅) 歩く。
    」。
    
    縦軸描画=「 | i  起点メモリ |
        幅=((floor(自分:_scale*i))+"")!長さ?。
        ラベル!(自分:_scale*i+起点メモリ) 作る  (自分:_原点x+(自分:_横幅/自分:_段数*i)-幅*5) (自分:_原点y-10)  位置  (自分：_軸ラベルサイズ)  文字サイズ  。
        ペン!1 線の太さ  (col) 線の色  ペンなし  (自分:_原点x+(自分:_横幅/自分:_段数)*i) (自分:_原点y)  位置 ペンあり  (自分:_縦幅)  歩く。	 
    」。
    ...
    「自分:_方向=="縦"」!なら「
        ...
        「自分:__max > ０」!なら「
            ...
            」実行。
            横軸描画!(i) (起点メモリ)実行。
            自分:_天井=自分:_原点y+(自分:_縦幅/自分:_段数)*i+30。
        」実行。
        ...
        「自分:_最小メモリ < ０」!なら「
            ...
            」実行。
            横軸描画!(i) (起点メモリ)実行。
            自分:_底=自分:_原点y+(自分:_縦幅/自分:_段数)*i-10。
        」実行。
    ...
    」そうでなければ「自分:_方向=="横"」なら「
        ...
        「自分:__max > ０」!なら「
            ...
            」実行。
            縦軸描画!(i) (起点メモリ) 実行。
            自分:_右端=自分:_原点x+(自分:_横幅/自分:_段数)*i+20。
        」実行。
        ...
        「自分:_最小メモリ < ０」!なら「
            ...
            」実行。
            縦軸描画!(i) (起点メモリ) 実行。
            自分:_左端=自分:_原点x+(自分:_横幅/自分:_段数)*i-40。
        」実行。
        
    」そうでなければ「自分:_方向=="帯"」なら「
        ペン＝タートル！  作る 1 線の太さ  (col) 線の色 90 左回り。
        ペン!ペンなし  (自分:_原点x) (自分:_原点y) 位置。
        自分:_底=自分:_原点y-40。
        自分:_天井=自分:_原点y+330。
        メモリ=0。
        ...
        「| i | 
            幅=(メモリ+"")!長さ？。
            ラベル!(メモリ)  作る    (自分：_軸ラベルサイズ)  文字サイズ (自分:_原点x+100*(i-1
            )-幅*5) (自分:_原点y-10) 位置。
            ペン!ペンあり  (自分:_縦幅)  歩く  。
            ペン!ペンなし  (自分:_原点x+100*i) (自分:_原点y) 位置。
            メモリ＝メモリ+20。
        」! 6 繰り返す。
        自分:_右端=自分:_原点x+500+20。
    ...
    」そうでなければ「自分:_方向=="散布図"」なら「
        ...
        「| i |
            ...
            「どれか!(どれか！(全部!(i==1) (自分:_グリッド線なし==true) 本当) (全部!(i==(自分:_段数y+1)) (自分:_グリッド線なし==true)本当 )本当) (自分:_グリッド線なし==false)  本当」！なら「
                ペン！ペンあり (自分:_横幅)  歩く。
            」実行。
            ペン!ペンなし (自分:_原点x) (自分:_原点y+自分:_横幅/自分:_段数y*i)  位置。
            ラベル!(自分:_scaley*(i-1)) 作る (自分：_軸ラベルサイズ)  文字サイズ   (自分:_原点x-調整-10) ((自分:_原点y+(自分:_縦幅/自分:_段数y)*(i-1))+10)  位置。
        」! (自分:_段数y+1)  繰り返す。 
        
        ペン!ペンなし  (自分:_原点x) (自分:_原点y) 位置  90  左回り。
        「| i |
            幅=((自分:_scalex*i)+"")!長さ?。
            「自分:_桁x==0」!なら「幅=3」実行。
            「どれか!(どれか！(全部!(i==1) (自分:_グリッド線なし==true) 本当) (全部!(i==(自分:_段数x+1)) (自分:_グリッド線なし==true)本当 )本当) (自分:_グリッド線なし==false)  本当」！なら「
                ペン！ペンあり (自分:_縦幅)  歩く。
            」実行。
            ペン!ペンなし (自分:_原点x+自分:_縦幅/自分:_段数x*i) (自分:_原点y)  位置。
            ラベル!(自分:_scalex*(i-1)) 作る (自分：_軸ラベルサイズ)  文字サイズ (自分:_原点x+(自分:_横幅/自分:_段数x*(i-1))-幅*5) (自分:_原点y-10) 位置。
        」! (自分:_段数x+1)  繰り返す。 
...
グラフ：最小二乗法＝「
    「自分:_方向=="散布図"」！なら「
        ...
        始点ｘ＝自分:_原点x。
        始点y=自分:_原点y+切片*自分:_DACOLY。
        終点x=自分:_原点x+x2*自分:_DACOLX。
        終点y=自分:_原点y+y2*自分:_DACOLY。
        「始点y < 自分:_原点y」！なら「始点x=(切片/(-1*傾き))*自分:_DACOLX+自分:_原点x。始点y=自分:_原点y」実行。
        「終点y > 自分：_縦幅」！なら「終点x=((_scaley*_段数y)-切片)/傾き*自分:_DACOLX+自分:_原点x。終点_y=(_scaley*_段数y)*自分:_DACOLX＋自分:_原点y」実行。
        
        ペン！(始点x) (始点y) 位置  ぺんあり (終点x) (終点y)  位置  (青) 図形を作る。
        傾き＝round(共分散/(標準偏差! 2 pow)*10000)/10000。
        切片＝round((y平均-（傾き*x平均)）*10000)/10000。
        ラベル！("y="+(傾き)+"x+"+(切片)) 作る (自分：_軸ラベルサイズ-4) 文字サイズ  (自分:_原点x+x2*自分:_DACOLX+10) (自分:_原点y+y2*自分:_DACOLY+5) 位置。
        ペン！消える。
        式の長さ=("y="+(傾き)+"x+"+(切片))!長さ？。
        自分:_右端=自分:_原点x+(自分:_横幅)+40+(式の長さ*10)。
        テーブル：x=自分:_右端。
        ラベル!"  " 作る  (自分:_右端) 0  位置。
    」実行。
    自分。
...
グラフ:縦表示＝「| 文字列 x y option　long ;文字数  _SIZE 調整|
    文字数＝文字列！長さ?。
    _SIZE=0。
    「option=="title"」!なら「_SIZE＝自分：_タイトルサイズ。」そうでなければ「_SIZE=自分：_軸ラベルサイズ」実行。
    「|i|
        tmp=配列！(文字列！(i) 1 部分) 作る。
        tmp!「|n j|
            付箋＝ラベル！(n) 作る (x) (y-15*i) 位置 (_SIZE) 文字サイズ。
            付箋：タイプ="縦軸タイトル"。
            //付箋：個体番号＝個体番号。
            自分:縦の位置=(y-12*i)。
        」それぞれ実行。
    」！(文字数)  繰り返す。
	「long!=undef」!なら「自分:_底=y-long*15-30」実行。
」。
...
テーブル：円グラフ=「 |f2|
    ...
    _円グラフ:描画=「| i |
        ...
        自分:_右端=自分:_原点x+x_pos+15*(_max_length)。
        テーブル：x=自分:_右端。
         ラベル!"　" 作る  (自分:_右端)  0 位置。
        ペン！消える．
        自分。
        ...
        data_x:データ!「|f cnt|
            ...
            「qua1!=undef」!なら「
                ...
                「自分:_方向=="縦"」！なら「
                    ...
                    //縦棒
                    ペン！ペンなし (自分:_原点x+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅+(自分:_プロット幅/2)) (自分:_原点y+_max*_DACOL)
                    ...
                    位置 ペンあり (自分:_原点x+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅+(自分:_プロット幅/2)) (自分:_原点y+_min*_DACOL) 位置．
                    ...
                    ペン！ペンなし (自分:_原点x+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅) (自分:_原点y+_max*_DACOL) 位置  ペンあり (自分:_プロット幅) 歩く。
                    ペン！ペンなし (自分:_原点x+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅) (自分:_原点y+_min*_DACOL) 位置  ペンあり (自分:_プロット幅) 歩く  ペンなし。
                    プロット＝ペン！図形にする。
                ...
                」そうでなければ「自分:_方向=="横"」なら「
                    ...
                    //縦棒
                    ペン！ペンなし (自分:_原点x+_max*_DACOL) (自分:_原点y+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅+(自分:_プロット幅/2))
                    ...
                    位置 ペンあり  (自分:_原点x+_min*_DACOL)   (自分:_原点y+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅+(自分:_プロット幅/2))位置．
                    ...
                    ペン！ペンなし (自分:_原点x+_max*_DACOL) (自分:_原点y+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅) 位置  ペンあり (自分:_プロット幅) 歩く。
                    ペン！ペンなし (自分:_原点x+_min*_DACOL) (自分:_原点y+(自分:_間隔+自分:_プロット幅)*cnt-自分:_プロット幅) 位置  ペンあり (自分:_プロット幅) 歩く  ペンなし。
                    プロット＝ペン！図形にする。
